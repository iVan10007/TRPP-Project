...
public class StocksAdapter extends PagerAdapter{
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        dascription = view.findViewById(R.id.description);

        imageView.setImageResource(stocksModelArrayList.get(position).getImage());
        title.setText(stocksModelArrayList.get(position).getTitle());
        dascription.setText(stocksModelArrayList.get(position).getDescription());
